...
В этом документе приведены инструкции по отладке хранилища, состояния, Service Worker и сессий в проекте **Kitsune-GENKI**.
...
3. Запись с ключом `state` содержит полный JSON-снапшот текущей версии приложения (State v13).
