...
describe('Multi-Version Sequential State Migration Safety', () => {
  it('migrates from v1 raw state to v15 maintaining progress', () => {
    const v1State = {
      xp: 120,
      level: 2,
  ...
  it('migrates from v5 state to v15 with pending review logs', () => {
    const v5State = {
      version: 5,
      xp: 500,
      srs: {
  ...
  it('migrates from v12 state to v15 state preserving active chapter', () => {
    const v12State = {
      version: 12,
      activeChapterId: 4,
      chapters: {
