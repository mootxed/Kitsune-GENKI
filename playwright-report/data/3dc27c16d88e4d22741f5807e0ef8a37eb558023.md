...
Locator: locator('[data-testid="onboarding-start-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="onboarding-start-btn"]')
...
- button "Settings":
  - img
- main:
  - heading "ChatDev 2.0 DevAll" [level=1]
  - paragraph: ChatDev 2.0 - DevAll is a zero-code multi-agent platform for developing everything, with a workspace built for designing, visualizing, and running agent workflows.
  - button "Get Started →"
```
