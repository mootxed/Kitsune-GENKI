...
- Name: grammar-quizzes-representative.spec.js >> Representative E2E Grammar Quizzes (Chapters 2, 6, 8, 12) >> Chapter 12: open topic L12_g1, complete quiz flow, and verify persistence after reload
...
Call log:
  - waiting for locator('#chapter-title') to be visible
    - locator resolved to hidden <h1 class="app-title" id="chapter-title">Глава</h1>
    - waiting for navigation to finish...
    - navigated to "http://localhost:3000/Kitsune-GENKI/#chapter/12"
    62 × locator resolved to hidden <h1 class="app-title" id="chapter-title">Глава</h1>
...
- generic [ref=f2e2]:
  - generic [ref=f2e9]:
    - generic [ref=f2e10]: Шаг 1 из 7
    - heading "Добро пожаловать в Kitsune Genki 🦊" [active] [level=2] [ref=f2e11]
    - paragraph [ref=f2e12]: "Приложение поможет пройти курс GENKI постепенно и эффективнее:"
    - list [ref=f2e13]:
      - listitem [ref=f2e14]: ✨ Новые слова небольшими порциями
      - listitem [ref=f2e15]: 🧠 Повторения по алгоритму FSRS
      - listitem [ref=f2e16]: 📚 Грамматика строго по порядку
      - listitem [ref=f2e17]: 📝 Задания и упражнения из Workbook
    - paragraph [ref=f2e18]: Давайте настроим ваш персональный учебный план.
    - button "Начать настройку →" [ref=f2e20] [cursor=pointer]
  - status
  - generic [ref=f2e21]: "Экран: Введение"
  - alert [ref=f2e22]
  - dialog:
    - generic:
      - generic:
