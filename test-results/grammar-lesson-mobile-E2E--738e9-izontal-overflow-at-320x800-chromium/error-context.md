...
- Name: grammar-lesson-mobile.spec.js >> E2E Grammar Lesson & Mobile Responsiveness >> Grammar quiz flow and no horizontal overflow at 320x800
...
Call log:
  - waiting for locator('#chapter-title') to be visible
    2 × locator resolved to hidden <h1 class="app-title" id="chapter-title">Глава</h1>
    - waiting for "http://localhost:3000/Kitsune-GENKI/" navigation to finish...
    - navigated to "http://localhost:3000/Kitsune-GENKI/#chapter/1"
    61 × locator resolved to hidden <h1 class="app-title" id="chapter-title">Глава</h1>
